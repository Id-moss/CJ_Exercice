...
class FlashListener implements EventSubscriberInterface
{
    ...
    private static $successMessages = array(
        FOSUserEvents::CHANGE_PASSWORD_COMPLETED => 'Password changed succefully.',
        ...
        FOSUserEvents::PROFILE_EDIT_COMPLETED => 'Profile updated !',
        FOSUserEvents::REGISTRATION_COMPLETED => 'Registration completed !',
        FOSUserEvents::RESETTING_RESET_COMPLETED => 'Password reset with success !',
    );
